...
class App {
	...
	private kleinBottle: KleinBottle
	...
	constructor() {
		...
		this.kleinBottle = new KleinBottle(gl, this.program)
	...
	render = () => {
		this.kleinBottle.render(this.cameraRotationX, this.cameraRotationY, this.lightIntensity)
